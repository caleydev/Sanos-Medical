...
export async function CTASection() {
  ...
  return (
    <section className="bg-background px-6 py-16">
      <div className="topographic soft-panel mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-6 overflow-hidden rounded-3xl p-8 ring-1 ring-white/10 sm:flex-row sm:items-center sm:p-10">
        <div>
          <h2 className="text-primary-foreground text-2xl font-bold tracking-tight text-balance sm:text-3xl">
            {t("title")}
          </h2>
          <p className="text-primary-foreground/85 mt-2 max-w-2xl text-pretty">
            {t("body")}
          </p>
        </div>
        <Link
